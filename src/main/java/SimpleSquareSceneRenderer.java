...
public class SimpleSquareSceneRenderer implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        shaderProgram = JoglUtils.createProgram(gl, "/vertex_shader.glsl", "/fragment_shader.glsl");
        ...
        // Load texture
        texture = JoglUtils.loadTexture("texture.png");
    ...
    private void forwardShaderUniforms(GL3 gl){
        ...
        int timeLocation = gl.glGetUniformLocation(shaderProgram, "time");
